...
interface ID3SvgLine {
            ...
            x(x: number): ID3SvgLine;
            x(x: (i: number) => number): ID3SvgLine;
            x<T>(x: (i: T) => number): ID3SvgLine;

            y(): number | ((i: number) => number);
            y(x: number): ID3SvgLine;
            y(y: (i: number) => number): ID3SvgLine;
            y<T>(y: (i: T) => number): ID3SvgLine;

            interpolate(): string | ((points: Array<[number, number]>) => string);
            interpolate(interpolate: "linear"): ID3SvgLine;
            interpolate(interpolate: "linear-closed"): ID3SvgLine;
            interpolate(interpolate: "step"): ID3SvgLine;
            interpolate(interpolate: "step-before"): ID3SvgLine;
            interpolate(interpolate: "step-after"): ID3SvgLine;
            interpolate(interpolate: "basis"): ID3SvgLine;
            interpolate(interpolate: "basis-open"): ID3SvgLine;
            interpolate(interpolate: "basis-closed"): ID3SvgLine;
            interpolate(interpolate: "bundle"): ID3SvgLine;
            interpolate(interpolate: "cardinal"): ID3SvgLine;
            interpolate(interpolate: "cardinal-open"): ID3SvgLine;
            interpolate(interpolate: "cardinal-closed"): ID3SvgLine;
            interpolate(interpolate: "monotone"): ID3SvgLine;
            interpolate(interpolate: string | ((points: Array<[number, number]>) => string)): ID3SvgLine;

            tension(): number;
            tension(tension: number): ID3SvgLine;

            defined(): (i: number) => boolean;
            defined(defined: (i: number) => boolean): ID3SvgLine;
}
...
// squash warnings
interface ID3_queueBase extends ID3Selectors {
    queue: string;
    defer: string;
    wait: string;
    waitAll: string;
...
declare var d3_queue: ID3_queueBase;
